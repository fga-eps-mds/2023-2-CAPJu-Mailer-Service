...
<body>
      <div style="background-color:#e5e5e5; font-family:Helvetica;font-size:13px;font-style:normal;font-weight:normal;letter-spacing:1px;line-height:130%;">
        <table style="margin: auto; width:80%; max-width: 1400px; align-items: center;">
        <div style="background-color:#49546fa6; width:100%; height: 200px;">
        ...
        <div style="background-color:#ffffff; color:#555555; width: 100%; padding-bottom: 60px; padding-top:50px">
          <div style="margin-left: 37px; font-size: 15px;">
            Olá, [NOME]
          </div>
          ...
          <div style="align-self: center;margin-top:30px;">
                ...
                <table class="fl-table" style="font-family:Helvetica;font-size:15px;font-style:normal;font-weight:normal; border:1px; margin:0 auto;">
                  <thead>
                  <tr>
